...
<template>
    <button v-if="theme=='dark'" @click="toggleTheme()" type="button" class="hs-dark-mode-active:hidden block hs-dark-mode group flex items-center text-gray-600 hover:text-rose-400 font-medium dark:text-gray-400 dark:hover:text-gray-500" data-hs-theme-click-value="dark">
    ...
    <button v-if="theme=='light'" @click="toggleTheme()" type="button" class="hs-dark-mode-active:block hs-dark-mode group flex items-center text-gray-600 hover:text-rose-400 font-medium dark:text-gray-400 dark:hover:text-gray-500" data-hs-theme-click-value="light">
