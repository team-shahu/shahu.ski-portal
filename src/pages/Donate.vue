<template>
    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div class="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:items-center">
            ...
            <h4 class="font-medium text-lg text-gray-800 dark:text-gray-200">ちょっと支援</h4>
            <span class="mt-7 font-bold text-5xl text-gray-800 dark:text-gray-200">
                <span class="font-bold text-2xl -me-2">￥</span>
                500 -</span>
            <p class="mt-2 text-sm text-gray-500">お財布に余裕はないけど、"ちょっとだけ"支援したい優しい方</p>
            ...
            <!-- Card -->
            <div class="flex flex-col border border-gray-200 text-center rounded-xl p-8 dark:border-gray-700">
            <h4 class="font-medium text-lg text-gray-800 dark:text-gray-200">いっぱい支援</h4>
            <span class="mt-5 font-bold text-5xl text-gray-800 dark:text-gray-200">
                <span class="font-bold text-2xl -me-2">￥</span>
                5,000 -
            </span>
            <p class="mt-2 text-sm text-gray-500">かなりお財布事情に余裕があり、いっぱい支援したい方</p>
            ...
            <!-- Card -->
            <div class="flex flex-col border border-gray-200 text-center rounded-xl p-8 dark:border-gray-700">
            <h4 class="font-medium text-lg text-gray-800 dark:text-gray-200">大富豪</h4>
            <span class="mt-5 font-bold text-5xl text-gray-800 dark:text-gray-200">
                <span class="font-bold text-2xl -me-2">￥</span>
                10,000 -
            </span>
